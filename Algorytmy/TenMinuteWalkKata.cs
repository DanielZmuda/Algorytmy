...
namespace Algorytmy
{
   ...
   //     a function that will return true if the walk the app gives you will take
   ...
   //letters ('n', 's', 'e', or 'w' only). It will never give you an empty array(that's not a walk, that's standing still!).
    ...
    class TenMinuteWalkKata
    {
     

        public static bool IsValidWalk(string[] walk)
        {
            int[] startingLocation = new int[2] { 0, 0 };
            ...
            return startingLocation[0] == 0 && startingLocation[1] == 0;
        }
    }
}
